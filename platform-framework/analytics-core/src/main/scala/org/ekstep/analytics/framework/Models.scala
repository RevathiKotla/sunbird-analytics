...
@scala.beans.BeanInfo
class V3Event(val eid: String, val ets: Long, val `@timestamp`: String, val ver: String, val mid: String, val actor: Actor, val context: V3Context, val `object`: Option[V3Object], val edata: V3EData, val tags: List[AnyRef] = null , val flags : Option[V3Flags]) extends AlgoInput with Input {}
...
@scala.beans.BeanInfo
case class V3Flags(derived_location_retrieved: Option[Boolean], device_data_retrieved: Option[Boolean],
                         user_data_retrieved: Option[Boolean], dialcode_data_retrieved: Option[Boolean],
                         content_data_retrieved: Option[Boolean])
